...
class UplinkInterface(wxMeta.SimpleApp):
    ...
    def GetLatestBalloonPos(self):
        ...
        url = "http://habitat.habhub.org/habitat/_design/habitat/_view/payload_telemetry?startkey=[%22{0}%22,%22latest%22]&descending=true&limit=1&include_docs=true".format(callsign_wanted)
