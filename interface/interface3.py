...
balloonPositionPollPeriod = 20000  # ms between balloon position updates
...
def FetchBalloonPosition():
    ...
    global balloonPositionPollPeriod
    ...
    # poll again after (balloonPositionPollPeriod) milliseconds
    app.after(balloonPositionPollPeriod, FetchBalloonPosition)
